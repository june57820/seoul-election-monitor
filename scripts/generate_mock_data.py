...
CANDIDATES = [
    {
        ...
        "main_pledges": "30분 통근도시|동부선·강북권 철도망|공간대전환|경부선 지하화|청년 생활정책",
        "persistent_issues": "교통|지하화|도시개발|주거|청년정책",
        "display_order": 1,
        "data_type": DATA_TYPE,
        "note": SEED_NOTE,
    },
    {
        ...
        "main_pledges": "31만호 주거 공급|쾌속통합 재개발|교통 대동맥|한강버스|광화문·도시공간 재편",
        "persistent_issues": "주거|재개발|교통|한강|도시개발",
        "display_order": 2,
        "data_type": DATA_TYPE,
        "note": SEED_NOTE,
    },
